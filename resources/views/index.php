...
<html lang="en">
  <head>
    ...
    <link href="mediaelementplayer.min.css" rel="stylesheet" type="text/css" />
    <!-- Animate -->
        ...
        <div class="col-sm-12">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html">
              <img class="img-fluid logo_img" id="logo_img" src="images/color-customizer/color-1.png" alt="#">
            </a>
      ...
      <div class="banner-text text-left">
        <div class="row justify-content-between">
          <div class="col-md-6 align-self-center">
            <h1 class="iq-font-white iq-tw-4">MY Thimphu <b> Latest Events and News</b></h1>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="heading-title text-center">
            <h2 class="title iq-tw-6">Our Great Features</h2>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 iq-mtb-15">
          <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
            <div>
              ...
              <h5 class="iq-tw-6">Creative Ideas</h5>
            </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 iq-mtb-15">
          <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
            <div>
              ...
              <h5 class="iq-tw-6">Beautiful Blog</h5>
            </div>
            <div class="content-blog">
              <p>Text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
            </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 iq-mtb-15">
          <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
            <div>
              ...
              <h5 class="iq-tw-6">Perfect Showcase</h5>
            </div>
            <div class="content-blog">
              <p>Text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
            </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 iq-mtb-15">
          <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
            <div>
              ...
              <h5 class="iq-tw-6">Color Schemes</h5>
            </div>
            <div class="content-blog">
              <p>Text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make.</p>
            </div>
